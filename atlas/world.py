class world(object):
	...
	def get_entities_in(self, top_left, top_right, bottom_left, bottom_right):
		...
		result = filter(lambda o: o.position['x'] > top_left['x'] and o.position['y'] > bottom_left['y'], self.entities)
		# is it inside the window
		result = filter(lambda o: o.position['y'] < bottom_left['y'] and o.position['x'] < top_right['x'], self.entities)
		return result
